 ...
 * @author Natalia
 */
public class ArchivoPreguntas extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        try{
            ...
            Object jsonObj = parser.parse(new FileReader("C:\\json_salidas\\parcial2.json"));
            ...
            out.println("<td style= rowspan='7' align='center' bgcolor='#f8f8f8'>Pregunta</td>");
            ...
            for (int i = 0; i < jsonObject.size(); i++) {
                ...
                String solution = (String) jsonObjectRow.get("question");
